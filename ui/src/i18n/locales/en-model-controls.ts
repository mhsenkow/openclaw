...
const enModelControls = {
  chat: {
    modelControls: {
      ...
      benefitWarmTitle: "Already loaded",
      benefitWarmDetail: "Resident in memory — first token should arrive quickly.",
      benefitSizeTitle: "Size",
      benefitSizeDetail: "Reported as {size}.",
      benefitNoKeyTitle: "No API key needed",
      benefitNoKeyDetail: "Runs on this machine without a cloud provider key.",
      warm: "Warm",
