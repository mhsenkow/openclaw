...
export const en: TranslationMap & {
  ...
  common: {
    ...
    colorModeTooltip: "Theme · {mode} — click to switch",
    colorModeTooltipSystem: "Theme · {mode} — follows your system",
    search: "Search",
  ...
  attention: {
    ...
    inboxTooltip: "Inbox — new requests and alerts",
    inboxTooltipCount: "Inbox — {count} waiting",
    tabs: {
  ...
  chat: {
    ...
    sidePanel: {
      ...
      agent: "Agent",
      agentEmpty: "Activity and approvals for this agent appear here.",
    ...
    composer: {
      ...
      options: {
        ...
        default: "Permission, model, and thinking",
        model: "Model",
      },
      reviewStrip: {
        title: "A task needs review",
        review: "Review",
      },
